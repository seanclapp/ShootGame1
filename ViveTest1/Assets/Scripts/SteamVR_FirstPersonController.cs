...
public class SteamVR_FirstPersonController : MonoBehaviour
{
    ...
    void InitController()
    {
        controllerAttachPoint = transform.GetChild(0).Find("PM-40_Top").GetComponent<Rigidbody>();
    ...
    void InitPointer()
    {
        ...
        pointerHolder.transform.localPosition = new Vector3(0,-1, 0);
    ...
    void SetPointerTransform(float setLength, float setThicknes)
    {
        ...
        else if(pointerFacingAxis == AxisType.ZAxis)
        {
        ...
        else
        {
            ...
            pointerTip.transform.localPosition = new Vector3(0f, setLength - (pointerTip.transform.localScale.y / 2), 0f);
